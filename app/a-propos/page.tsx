    ...
    <div className="min-h-screen" style={{background:'var(--bg-main)'}}>
      ...
      <section style={{padding:'96px 0',background:'var(--bg-main)'}}>
        <div style={{maxWidth:'1100px',margin:'0 auto',padding:'0 24px'}}>
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'80px',alignItems:'center'}}>
            <div>
              <p style={{fontSize:'11px',fontWeight:900,textTransform:'uppercase',letterSpacing:'0.1em',color:'var(--orange)',marginBottom:'16px'}}>La genèse du projet</p>
              <h2 style={{fontSize:'clamp(1.8rem,3.5vw,2.8rem)',fontWeight:900,color:'var(--text-primary)',lineHeight:1.1,marginBottom:'24px'}}>
                Un problème réel. Une réponse concrète.
              </h2>
              <p style={{fontSize:'1rem',color:'var(--text-secondary)',lineHeight:1.85,marginBottom:'20px'}}>
                Face au constat que des milliers de travailleurs sont victimes chaque année d&apos;accidents évitables par manque de formation, <strong style={{color:'var(--text-primary)'}}>Grange AGBODANDE</strong>, ingénieur avec plus de 10 ans d&apos;expérience en sécurité EPI, a imaginé cette plateforme : rendre la formation sécurité aussi simple et gratuite qu&apos;une recherche sur internet.
              </p>
              <p style={{fontSize:'1rem',color:'var(--text-secondary)',lineHeight:1.85,marginBottom:'20px'}}>
            ...
            <div style={{position:'relative'}}>
              ...
              <div style={{position:'absolute',bottom:'-16px',left:'-16px',padding:'18px 22px',borderRadius:'18px',background:'var(--bg-card)',border:'1px solid var(--border)',boxShadow:'0 12px 32px rgba(0,0,0,0.12)'}}>
                <div style={{display:'flex',alignItems:'center',gap:'10px'}}>
                  ...
                  <div>
                    <p style={{fontSize:'13px',fontWeight:900,color:'var(--text-primary)',margin:0}}>Mission sécurité</p>
              ...
              <div style={{position:'absolute',top:'-16px',right:'-16px',padding:'14px 18px',borderRadius:'16px',background:'var(--orange)',boxShadow:'0 8px 24px rgba(212,80,15,0.4)'}}>
                ...
                <div style={{fontSize:'10px',color:'rgba(255,255,255,0.85)',marginTop:'2px'}}>ans d&apos;expérience</div>
              </div>
            </div>
          </div>
        </div>
              ...
              <div style={{padding:'56px 28px 28px 28px'}}>
                ...
                <div style={{display:'flex',gap:'8px',paddingTop:'16px',borderTop:'1px solid var(--border)'}}>
                  <a href="https://portfolio-djlo.vercel.app/" target="_blank" rel="noopener noreferrer" style={{display:'inline-flex',alignItems:'center',gap:'6px',padding:'8px 14px',borderRadius:'10px',fontSize:'12px',fontWeight:700,color:'#3b82f6',textDecoration:'none',background:'rgba(59,130,246,0.08)',border:'1px solid rgba(59,130,246,0.2)'}}>
                    <ExternalLink size={12}/>Voir le portfolio
                  </a>
                </div>
              </div>
            </div>
      ...
      <section style={{padding:'96px 0',background:'var(--bg-main)'}}>
        <div style={{maxWidth:'1100px',margin:'0 auto',padding:'0 24px'}}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(4,1fr)',gap:'20px'}}>
            {[
              {Icon:Heart,  titre:"Accessibilité",   desc:"Toutes nos ressources sont 100% gratuites et disponibles sans inscription. La sécurité ne devrait pas avoir de prix.",color:"#ef4444"},
              {Icon:Globe,  titre:"Universalité",    desc:"Pensé pour être utilisé partout dans le monde, dans tous les secteurs et dans toutes les langues.",color:"#3b82f6"},
              {Icon:Target, titre:"Pertinence",      desc:"Chaque contenu est validé par des experts du terrain. Des ressources vraiment utiles, pas du générique.",color:"#f97316"},
              {Icon:Shield, titre:"Fiabilité",       desc:"Nous veillons à la qualité et à la mise à jour permanente de nos ressources pour garantir une information exacte.",color:"#22c55e"},
            ].map((v,i)=>(
      ...
      <section style={{padding:'80px 0',background:'var(--bg-secondary)'}}>
        <div style={{maxWidth:'760px',margin:'0 auto',padding:'0 24px',textAlign:'center'}}>
          <div style={{padding:'48px',borderRadius:'28px',border:'2px dashed rgba(239,68,68,0.3)',background:'rgba(239,68,68,0.04)'}}>
            ...
            <div style={{display:'flex',gap:'12px',justifyContent:'center',flexWrap:'wrap'}}>
              <a href="https://paypal.me/thinksafety" target="_blank" rel="noopener noreferrer"
                style={{display:'inline-flex',alignItems:'center',gap:'8px',padding:'14px 32px',borderRadius:'16px',fontSize:'15px',fontWeight:900,color:'white',textDecoration:'none',background:'linear-gradient(135deg,#ef4444,#dc2626)',boxShadow:'0 8px 24px rgba(239,68,68,0.35)'}}>
                <Heart size={16} fill="white"/> Faire un don volontaire
              </a>
              <Link href="/secteurs" style={{display:'inline-flex',alignItems:'center',gap:'8px',padding:'14px 28px',borderRadius:'16px',fontSize:'15px',fontWeight:700,color:'var(--text-primary)',textDecoration:'none',background:'var(--bg-card)',border:'1px solid var(--border)'}}>
