...
const ALERTES = [
  ...
  { id: 4, titre: 'Casques de chantier contrefaits en circulation', contenu: 'Des EPI non conformes ont ete detectes sur plusieurs marches. Verifiez toujours le marquage CE et la norme EN 397 avant achat.', niveau: 'attention', secteur: 'Construction BTP', region: 'Cotonou, Benin', date: '15 Dec 2024', source: 'Thinks Safety' },
