        ...
        <div style={{width:'100%',maxWidth:'400px'}}>
          ...
          <div style={{background:'var(--bg-card)',border:'1px solid var(--border)',borderRadius:'20px',padding:'32px'}}>
            ...
            <div style={{marginBottom:'16px'}}>
              ...
              <input type="email" value={email} onChange={e=>setEmail(e.target.value)} onKeyDown={handleKeyDown} placeholder="email@exemple.com"
            ...
            <div style={{marginBottom:'10px'}}>
              ...
              <div style={{position:'relative'}}>
                <input type={showPwd?'text':'password'} value={password} onChange={e=>setPassword(e.target.value)} onKeyDown={handleKeyDown} placeholder="Votre mot de passe"
            ...
            <div style={{textAlign:'right',marginBottom:'24px'}}>
              <Link href="/mot-de-passe-oublie" style={{fontSize:'12px',color:'var(--orange)',textDecoration:'none',fontWeight:600}}>Mot de passe oublié ?</Link>
            </div>
